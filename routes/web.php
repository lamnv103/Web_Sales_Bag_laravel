...
Route::get('/', [AdminController::class, 'index_1'])->name('home.index');
...
Route::get('/review/create/{order_id}', [HomeController::class, 'review_create'])->name('user.review.deliver');
Route::post('/review/store', [HomeController::class, 'review_store'])->name('user.review.store');
...
Route::middleware(['auth',AuthAdmin::class])->group(function(){
    ...
    Route::get('/admin/brand/{id}', [AdminController::class, 'show_brand'])->name('admin.brand.show');
    Route::post('/admin/brands/update/{id}', [AdminController::class, 'updateBrandProductCount'])->name('admin.update.brand.count');
    ...
    Route::get('/admin/category/{id}', [AdminController::class, 'show_category'])->name('admin.category.show');
    Route::post('/admin/categories/update/{id}', [AdminController::class, 'updateCategoryProductCount'])->name('admin.update.category.count');
    ...
    Route::get('/admin/contact/{id}/show', [AdminController::class,'contact_show'])->name('admin.contact.show');
    Route::post('/admin/contact/{id}/response', [AdminController::class, 'sendResponse'])->name('admin.contact.sendResponse');
    ...
    Route::get('/admin/review', [AdminController::class,'review'])->name('admin.reviews');
    Route::post('admin/reviews/{id}/approve', [AdminController::class, 'approveReview'])->name('admin.reviews.approve');
    Route::delete('/admin/reviews/{id}/delete', [AdminController::class,'review_delete'])->name('admin.reviews.delete');
...
// Route::post('/broadcast', [PusherController::class, 'broadcast'])->name('chat.broadcast');caca