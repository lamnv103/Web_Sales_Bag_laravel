                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="list-icon-function">
                                        <a href="<?php echo e(route('admin.contact.show',['id'=>$contact->id])); ?>">
                                        ...
                                        <form action="<?php echo e(route('admin.contact.delete', ['id'=>$contact->id])); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luxury-shop-new\resources\views/admin/contacts.blade.php ENDPATH**/ ?>