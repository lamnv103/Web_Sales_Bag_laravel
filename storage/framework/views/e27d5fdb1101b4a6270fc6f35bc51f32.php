          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  style="background: linear-gradient(45deg, #df85eb, #f3b8db, #d8dde1)">
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      PHỤ KIỆN<br /><strong>Nữ</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Phụ kiện là cách tốt nhất để
                      làm mới diện mạo của bạn. Thêm một đường viền tiêu đề với kiểu dáng và màu sắc mới hoặc chọn những món đồ vượt thời gian.</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="<?php echo e(asset('assets/images/shop/shop_banner3.jpg')); ?>" width="630" height="450"
            ...
            <div class="swiper-slide">
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                ...
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="<?php echo e(asset('assets/images/shop/paner1.jpg')); ?>" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
...
làm mới diện mạo của bạn. Thêm một đường viền tiêu đề với kiểu dáng và màu sắc mới hoặc chọn những món đồ vượt thời gian.</h6>
                ...
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="<?php echo e(asset('assets/images/shop/paner2.jpg')); ?>" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
            <a href="<?php echo e(route('home.index')); ?>" class="menu-link menu-link_us-s text-uppercase fw-medium">Trang chủ</a>
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1" >
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page size"
              ...
              <option value="12" <?php echo e($size == 12 ? 'selected':''); ?>>Hiển thị</option>
            ...
            <option value="-1" <?php echo e($order == -1 ? 'selected':''); ?>>Mặc định</option>
            <option value="1" <?php echo e($order == 1 ? 'selected':''); ?>>Mới đến cũ</option>
            <option value="2" <?php echo e($order == 2 ? 'selected':''); ?>>Cũ đến mới</option>
            <option value="3" <?php echo e($order == 3 ? 'selected':''); ?>>Giá, thấp đến cao</option>
            <option value="4" <?php echo e($order == 4 ? 'selected':''); ?>>Giá, cao đến thấp</option>
          </select>
          ...
          <div class="product-card-wrapper">
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="<?php echo e(route('shop.product.details', ['product_slug' => $product->slug])); ?>">
                            <img loading="lazy" src="<?php echo e(asset('uploads/products')); ?>/<?php echo e($product->image); ?>" width="330" height="400" alt="<?php echo e($product->name); ?>" class="pc__img">
                        </a>
                    </div>
                
                    <!-- Ảnh thư viện của sản phẩm -->
                    <?php $__currentLoopData = explode(",", $product->images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide">
                            <a href="<?php echo e(route('shop.product.details', ['product_slug' => $product->slug])); ?>">
                                <img loading="lazy" src="<?php echo e(asset('uploads/products')); ?>/<?php echo e($gimg); ?>" width="330" height="400" alt="<?php echo e($product->name); ?>" class="pc__img">
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <a href="<?php echo e(route('cart.index')); ?>" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn btn-warning mb-3">Đi đến giỏ hàng</a>
                <?php else: ?>
        ...
        <div class="flex items-center justify-between flex_wrap gap10 wgp-pagination">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luxury-shop-new\resources\views/shop.blade.php ENDPATH**/ ?>