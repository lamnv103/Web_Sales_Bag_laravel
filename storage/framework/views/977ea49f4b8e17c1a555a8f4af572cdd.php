                    ...
                    <div class="wg-box">
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter product name"
                                name="name" tabindex="0" value="<?php echo e($product->name); ?>" aria-required="true" required="">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter product slug"
                                name="slug" tabindex="0" value="<?php echo e($product->slug); ?>" aria-required="true" required="">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <fieldset class="shortdescription">
                            ...
                            <textarea class="mb-10 ht-150" name="short_description"
                                ...
                                required=""><?php echo e($product->short_description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <fieldset class="description">
                            ...
                            <textarea class="mb-10" name="description" placeholder="Description"
                                tabindex="0" aria-required="true" required=""><?php echo e($product->description); ?></textarea>
                            <div class="text-tiny">Không được vượt quá 5000 ký tự khi nhập
                                tên sản phẩm.</div>
                        </fieldset>
                        ...
                        <div class="cols gap22">
                            <fieldset class="name">
                                ...
                                <input class="mb-10" type="text" placeholder="Enter regular price"
                                    name="regular_price" tabindex="0" value="<?php echo e($product->regular_price); ?>" aria-required="true"
                                    required="">
                            </fieldset>
...
unset($__errorArgs, $__bag); ?>
                            <fieldset class="name">
                                ...
                                <input class="mb-10" type="text" placeholder="Enter sale price"
                                    name="sale_price" tabindex="0" value="<?php echo e($product->sale_price); ?>" aria-required="true"
                                    required="">
                            </fieldset>
...
unset($__errorArgs, $__bag); ?>
                            <fieldset class="name">
                                ...
                                <input class="mb-10" type="text" placeholder="Enter quantity"
                                    name="quantity" tabindex="0" value="<?php echo e($product->quantity); ?>" aria-required="true"
                                    required="">
                            </fieldset>
                            ...
                            <fieldset class="name">
                                ...
                                <div class="select mb-10">
                                    <select class="" name="stock_status">
                                        <option value="in_stock" <?php echo e($product->stock_status == "in_stock" ? "selected":""); ?>>Còn hàng</option>
                                        <option value="out_of_stock" <?php echo e($product->stock_status == "out_of_stock" ? "selected":""); ?>>Hết hàng</option>
                                    </select>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="name">
                                ...
                                <div class="select mb-10">
                                    <select class="" name="featured">
                                        <option value="0" <?php echo e($product->featured == "0" ? "selected":""); ?>>Không </option>
                                        <option value="1" <?php echo e($product->featured == "1" ? "selected":""); ?>>Có </option>
                                    </select>
                                </div>
                            </fieldset>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luxury-shop-new\resources\views/admin/product-edit.blade.php ENDPATH**/ ?>