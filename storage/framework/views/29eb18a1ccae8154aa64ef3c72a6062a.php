                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('admin.category.show', ['id' => $category->id])); ?>" target="_blank">
                                            <?php echo e($category->product_count); ?>

                                        </a>
                                    </td>
                                    <td>
                                        <form action="<?php echo e(route('admin.update.category.count', ['id' => $category->id])); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luxury-shop-new\resources\views/admin/categories.blade.php ENDPATH**/ ?>