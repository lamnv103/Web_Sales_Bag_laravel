        ...
        <div class="mw-930">
            <div class="contact-us__form">
                ...
                <div class="form-floating my-4">
                    <input type="text" class="form-control" name="name" placeholder="Name *" value="<?php echo e($contacts->name); ?>" disabled>
                    <label for="contact_us_name">Tên *</label>
                </div>
                <div class="form-floating my-4">
                    <input type="text" class="form-control" name="phone" placeholder="Phone *" value="<?php echo e($contacts->phone); ?>" disabled>
                    <label for="contact_us_name">Điện thoại *</label>
                </div>
                <div class="form-floating my-4">
                    <input type="email" class="form-control" name="email" placeholder="Email address *" value="<?php echo e($contacts->email); ?>" disabled>
                    <label for="contact_us_name">Địa chỉ email *</label>
                </div>
                <div class="my-4">
                    <textarea class="form-control form-control_gray" name="comment" placeholder="Your Message" disabled cols="30" rows="8"><?php echo e($contacts->comment); ?></textarea>
                </div>
                ...
                <div id="reply-form-container" style="display: none;">
                    <form action="<?php echo e(route('admin.contact.sendResponse', ['id' => $contacts->id])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luxury-shop-new\resources\views/admin/contacts-show.blade.php ENDPATH**/ ?>